...
//
const BotName = '𝙲𝙰𝙻𝙸𝙿𝙷 𝙱𝙾𝚃'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/caliph91_'; // Nama Instagramlu cok
const whatsapplu = 'https://bit.ly/owner_bot'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://bit.ly/2JpM3vU'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://bit.ly/37xxNto'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id, BotName, tampilTanggal, tampilWaktu, instagramlu, whatsapplu, kapanbotaktif, grupch1, grupch2) ,MessageType.text);
}
else if (text == '%donasi'){
var date = new Date();
var tahun = date.getFullYear();
...
if (text.includes("%alay")){
	...
	axios.get(`https://arugaz.herokuapp.com/api/bapakfont?kata=${alay}`).then ((res) =>
